...
public abstract class AbstractWrapper<T, R, This extends AbstractWrapper<T, R, This>> extends Wrapper<T>
    ...
    protected List<String> sqlRecordList = new ArrayList<>();
    protected Boolean sqlRecordListIsValid = true;
    ...
    public This like(boolean condition, R column, Object val) {
        if (condition){
            sqlRecordList.add(columnToString(column) + " " + LIKE.getSqlSegment() + " " + StringPool.PERCENT + val + StringPool.PERCENT);
        }
    ...
    public This notLike(boolean condition, R column, Object val) {
        if (condition){
            sqlRecordList.add( " notLike " + NOT.getSqlSegment());
        }
    ...
    public This likeLeft(boolean condition, R column, Object val) {
        if (condition){
            sqlRecordList.add(columnToString(column) + " " + LIKE.getSqlSegment() + " " + StringPool.PERCENT + val);
        }
    ...
    public This likeRight(boolean condition, R column, Object val) {
        if (condition){
            sqlRecordList.add(columnToString(column) + " " + LIKE.getSqlSegment() + " " + val + StringPool.PERCENT);
        }
    ...
    public This between(boolean condition, R column, Object val1, Object val2) {
        if (condition){
            sqlRecordList.add(columnToString(column) + " " + BETWEEN.getSqlSegment() + " " + val1 + " " + AND.getSqlSegment() + " " + val2 );
        }
        return doIt(condition, () -> columnToString(column), BETWEEN, () -> formatSql("{0}", val1), AND, () -> formatSql("{0}", val2));
    }

    @Override
    public This notBetween(boolean condition, R column, Object val1, Object val2) {
        if (condition){
            sqlRecordList.add(" notBetween " + NOT.getSqlSegment());
        }
    ...
    public This and(boolean condition, Function<This, This> func) {
        sqlRecordListIsValid = false; //这种查询太变态,获取不了sql, 就不走缓存了
    ...
    public This apply(boolean condition, String applySql, Object... value) {
        if (condition){
            ...
            sqlRecordList.add(APPLY.getSqlSegment() + " " + applySql + " " + sb.toString());
        }
    ...
    public This last(boolean condition, String lastSql) {
        if (condition) {
            ...
            sqlRecordList.add(this.lastSql);
        }
        return typedThis;
    }
    ...
    public This exists(boolean condition, String existsSql) {
        if (condition){
            sqlRecordList.add(EXISTS.getSqlSegment() + " " + existsSql );
        }
    ...
    public This notExists(boolean condition, String notExistsSql) {
        if (condition){
            sqlRecordList.add(" notExists " + NOT.getSqlSegment());
        }
    ...
    public This isNull(boolean condition, R column) {
        if (condition){
            sqlRecordList.add(columnToString(column) + " " + IS_NULL.getSqlSegment());
        }
    ...
    public This isNotNull(boolean condition, R column) {
        if (condition){
            sqlRecordList.add(columnToString(column) + " " + IS_NOT_NULL.getSqlSegment());
        }
    ...
    public This in(boolean condition, R column, Collection<?> value) {
        ...
        if (condition){
            sqlRecordList.add(columnToString(column) + " " + IN.getSqlSegment() + " " + value.toString() );
        }
    ...
    public This notIn(boolean condition, R column, Collection<?> value) {
        ...
        if (condition){
            sqlRecordList.add(" notIn " + NOT.getSqlSegment());
        }
    ...
    public This inSql(boolean condition, R column, String inValue) {
        if (condition){
            sqlRecordList.add(columnToString(column) + " " + IN.getSqlSegment() + " " + inValue );
        }
    ...
    public This notInSql(boolean condition, R column, String inValue) {
        if (condition){
            sqlRecordList.add(" notInSql " + NOT.getSqlSegment());
        }
    ...
    public This groupBy(boolean condition, R... columns) {
        ...
        if (condition){
            sqlRecordList.add(GROUP_BY.getSqlSegment() + " " + columnsToString(columns));
        }
    ...
    public This orderBy(boolean condition, boolean isAsc, R... columns) {
        ...
        StringBuilder sb = new StringBuilder(ORDER_BY.getSqlSegment()).append(" ");
        SqlKeyword mode = isAsc ? ASC : DESC;
        for (R column : columns) {
            sb.append(columnToString(column)).append(" ");
            doIt(condition, ORDER_BY, () -> columnToString(column), mode);
        }
        sb.append(mode.getSqlSegment());
        if (condition){
            sqlRecordList.add(sb.toString());
        }
        return typedThis;
    }
    ...
    public This having(boolean condition, String sqlHaving, Object... params) {
        if(condition){
            ...
            sqlRecordList.add(HAVING.getSqlSegment() + " " + sqlHaving + sb.toString());
        }
    ...
    protected This addCondition(boolean condition, R column, SqlKeyword sqlKeyword, Object val) {
        if (condition){
            sqlRecordList.add(columnToString(column) + sqlKeyword.getSqlSegment() + val);
        }
